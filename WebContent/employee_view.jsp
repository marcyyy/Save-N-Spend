            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                            <h4 class="title" style="font-size:50px;font-weight:bold;margin-left:10px;margin-top:5px">Employees List</h4>
...
<td>${u.getAge()}</td>
<td>${u.getGender()}</td>
<td><a href="employee_editform.jsp?id=${u.getId()}"><img src="assets/images/edit-icon.png" height="25" width="25"></a></td>
<td><a href="employee_delete.jsp"><img src="assets/images/delete-icon.png" height="25" width="25"></a></td>
                                      ...
                                      <div class="text-right" style="margin-right:10px">
                                        <a href="employee_addform.jsp"><button type="submit" class="btn btn-info btn-fill btn-wd">ADD NEW EMPLOYEE</button></a>
                                  </div>
                                </div>
                        </div>
                    </div>
