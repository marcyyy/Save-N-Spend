...
<td><a href="au_client_editform.jsp?id=${u.getId()}"><img src="../assets/images/edit-icon.png" height="25" width="25"></a></td>
<td><a href="au_client_delete.jsp?id=${u.getId()}"><img src="../assets/images/delete-icon.png" height="25" width="25"></a></td>
...
<%@page import="com.javatpoint.dao.ClientDao2,com.javatpoint.bean.*,java.util.*"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>

<%
List<Client2> list2=ClientDao2.getAllRecords();
