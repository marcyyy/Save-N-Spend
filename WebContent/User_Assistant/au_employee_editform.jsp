<!doctype html>
<html lang="en">
<title>Save and Spend | Edit Employee</title>
            ...
            <div class="container">
                <div class="row">
                     <div class="col-lg-8 col-md-7" style="width:100%">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="font-size:50px;font-weight:bold;margin-left:550px;margin-top:5px"><font color = "teal">Edit Employee</font></h4>
                                        <a href="au_employee_view.jsp"><input type="button" class="btn btn-info btn-fill btn-wd" value="VIEW ALL RECORDS"></a>
                            </div>
                            <hr>
                            <div class="content">
                                <form action="au_employee_edit.jsp" method="post">
                                ...
                                <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group" style="margin-left:50px;">
                                                ...
                                                <input type="text" name="email" class="form-control border-input" value="<%=u.getEmail()%>">
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group" style="margin-left:200px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        <input type="submit" class="btn btn-info btn-fill btn-wd" value="UPDATE EMPLOYEE" style="width:300px; height:50px; margin-bottom:20px">
                                    </div>
                                </form>
                            </div>
                        </div>
