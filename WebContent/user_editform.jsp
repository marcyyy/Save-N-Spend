<!doctype html>
	<html lang="en">
		<title>Save and Spend | Edit User</title>
            ...
            <div class="container">
                <div class="row">
                     <div class="col-lg-8 col-md-7" style="width:100%">
                        <div class="card">
                            <div class="header">
                                <h4 class="title" style="font-size:50px;font-weight:bold;margin-left:700px;margin-top:5px"><font color ="teal">Edit User</font></h4>
                            ...
                            <div class="content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center">
                                        <input type="submit" class="btn btn-info btn-fill btn-wd" value="UPDATE USER" style="width:300px; height:50px; margin-bottom:20px">
                                    </div>
                                </form>
                            </div>
                        </div>
